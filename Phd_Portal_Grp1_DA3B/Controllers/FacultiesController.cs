...
namespace Phd_Portal_Grp1_DA3B.Controllers
{
    public class FacultiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId,Faculty_type")] Faculty faculty)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,Faculty_type")] Faculty faculty)
        {
